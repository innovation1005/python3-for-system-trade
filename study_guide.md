...
また、本書のプログラムコードが用いるデータですが、多くはyahoo finance または　fredからダウンロードしますが、一部購入するしか手に入らないデータがあります。出版社のご厚意で、その一部のデータに関してダウンロード可能です。データの著作権上すべてのデータを配布出来ないことをご了承ください。データのダウンロードは「Python3ではじめるシステムトレード」購入者に限り、panrolling社のホームページから可能です。
