...
と書けます。dx/xは変化率、またはリターンと呼ばれるものです。したがって、時間の変化をゼロに近づけると微少時間の変化になります。したがって、価格の対数をとってグラフに描くとその一点一点の動きは瞬間的な変化率ととらえることができます。△x/xは価格の弾力性ととらえることができるので、価格の対数を用いて価格の動きをグラフにすると弾力性をとらえていると考えることもできます。
